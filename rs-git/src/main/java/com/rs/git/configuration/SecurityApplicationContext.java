package com.rs.git.configuration;
...
import com.rs.core.security.filter.RestApplicationAuthorizationFilter;
...
public class SecurityApplicationContext extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.exceptionHandling()
                ...
                .and()
                .addFilterAfter(enableRestApplicationAuthFilter(), SessionManagementFilter.class)
                .addFilterAfter(enableRestUserAuthFilter(), RestApplicationAuthorizationFilter.class)
    ...
    @Bean
    public RestApplicationAuthorizationFilter enableRestApplicationAuthFilter() {
        return new RestApplicationAuthorizationFilter(restTemplate,
                authUri,
                appAuthHeader,
                String.valueOf(serviceName.hashCode()));
    }
