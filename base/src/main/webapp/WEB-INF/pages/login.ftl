...
<div class="navbar navbar-inverse">
    <div class="navbar-header">
        <a class="navbar-brand" href="<@spring.url '/'/>"><img src="/resources/assets/images/logo_light.png" alt=""></a>
    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <!-- Simple login form -->
                <form action="<@spring.url '/public/login'/>" method="post">
                    <div class="panel panel-body login-form">
                        ...
                        <div class="text-center">
                            <a href="<@spring.url '/login/recovery'/>">Forgot password?</a>
                        </div>
                    </div>
                </form>
                <!-- /simple login form -->
