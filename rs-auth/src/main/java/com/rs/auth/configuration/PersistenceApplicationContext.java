...
@EnableJpaRepositories(basePackages = "com.rs.auth", repositoryFactoryBeanClass = BaseJpaRepositoryFactoryBean.class)
public class PersistenceApplicationContext {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource, Environment env) {
        ...
        entityManagerFactoryBean.setPackagesToScan("com.rs.auth");
